...
#include <sys/stat.h>
#include <unistd.h>
#include "/home/repos/ardupilot/libraries/AP_Mission/AP_Mission.h"
...
{ 
  ...
  //__serialize_scalarInt8((unsigned char *)(& ptr->check_flag), fd);
  ...
  //__serialize___anonunion_ap_t((union __anonunion_ap_t *)(& ptr->ap_t), fd);
...
{ 
  ...
  //__deserialize_scalarInt8((unsigned char *)(& ptr->check_flag), fd);
